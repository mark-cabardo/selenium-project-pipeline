...
public class BaseTest {
	...
	public void takescreenshot() throws IOException{
		...
		FileUtils.copyFile(scrFile, new File("C:\\Workspace\\SeleniumProject2\\test-reports\\screenshots\\"+ getFileName(this.getClass().getSimpleName())));
		} catch (Exception e){
  ...
  public static int getRowContains(int colNum, String sTestCaseName) throws Exception{
	...
	public void assertValuePresentInElement(String locator, String locType, int colNum) throws Exception{
		...
		Assert.assertTrue(driver.findElement(By.id(locator)).getAttribute("value").equals(valueToCheck));
		log("The value "+ valueToCheck + "is present in the web element.");
		
		} else if (locType.equalsIgnoreCase("name")){
			
		Assert.assertTrue(driver.findElement(By.name(locator)).getAttribute("value").equals(valueToCheck));
		log("The value "+ valueToCheck + "is present in the web element.");
		
		} else if (locType.equalsIgnoreCase("class")){
			
		Assert.assertTrue(driver.findElement(By.className(locator)).getAttribute("value").equals(valueToCheck));
		log("The value "+ valueToCheck + "is present in the web element.");
		
		} else {
			
		Assert.assertTrue(driver.findElement(By.xpath(locator)).getAttribute("value").equals(valueToCheck));
		log("The value "+ valueToCheck + "is present in the web element.");
		
			}
		} catch (Exception e){
			 
			log("Value is not present in the web element.");
			 e.printStackTrace();
